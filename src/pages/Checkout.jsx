    ...
    <div className="container mx-auto px-4 py-16">
      ...
      >
        ...
        <div className="order-1 flex min-w-0 flex-col gap-8 lg:col-start-2 lg:row-span-2 lg:row-start-1">
          {/* Mobile: cart first — Desktop: cart below payment */}
          <motion.div
          ...
          >
            <div className="card p-6">
              <h2 className="text-2xl font-bold text-chana-brown mb-6">Your Cart</h2>
                  ...
                  <div key={`${item.id}-${item.weightType}`} className="flex gap-4 border-b pb-4">
                    ...
                    <div className="flex-grow min-w-0">
                      ...
                      <p className="text-sm font-semibold text-green-600">
                        ...
                        <span className="text-gray-400 line-through">Rs {itemTotal}</span>
                      </p>
                      ...
                      <div className="flex items-center gap-2 mt-2 flex-wrap">
                        <button
                          type="button"
                          onClick={() =>
                            updateQuantity(item.id, item.weightType, item.quantity - 1)
                          }
              ...
              <div className="mt-6 space-y-2 text-lg">
                <div className="flex justify-between gap-2">
                  <span>Subtotal:</span>
                  <span className="font-semibold tabular-nums">Rs {subtotal}</span>
                </div>
                <div className="flex justify-between gap-2 text-green-600">
                  <span>Discount (10%):</span>
                  <span className="font-semibold tabular-nums">-Rs {discount.toFixed(0)}</span>
                </div>
                <div className="flex justify-between gap-2">
          ...
          >
            <div className="card p-6">
              <h2 className="text-2xl font-bold text-chana-brown mb-6">Payment Method</h2>
        ...
        >
          <div className="card p-6 flex flex-col h-full min-h-0">
            <h2 className="text-2xl font-bold text-chana-brown mb-6">Customer Details</h2>
