...
function Header() {
  ...
  const announcements = [
    ...
    { text: "📍 Currently Serving Karachi Only - More Cities Coming Soon!", icon: "📍" },
      ...
      <div className="bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 text-white text-center py-3 overflow-hidden relative">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="relative z-10 font-semibold text-sm md:text-base flex items-center justify-center gap-2"
          >
            <motion.span
