...
import mobileBannerImg from "../../public/images/mobilebanner.png";
  ...
  return (
    <section className="relative min-h-[450px] md:min-h-[600px] flex items-center overflow-hidden py-10 md:py-16 bg-[#0a0500] font-sans">
      ...
      <motion.div
        ...
        className={`absolute inset-0 z-0 bg-contain md:bg-cover bg-no-repeat bg-center ${isMobile ? "bg-fixed" : "bg-scroll"}`}
        style={{
          backgroundImage: `url(${isMobile ? mobileBannerImg : bannerImg})`,
